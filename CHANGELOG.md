...
- Sección token bajo pricing: play neón en SVG + título + barra + 3 cards (Launched in con logos Robinhood/Pump, Fees 1%, Official X) con tops por modo (4340/4520/3640) y alturas de página ajustadas. Logos copiados a `public/logo-*.svg`. Título en placeholder (venía tapado). Build ✅.
